...
-- INSERT INTO tbldepartment VALUES ('Research','5','333445555','1978-05-22'),
...
--  references tbldepartment(Dnumber) on delete set null on update CASCADE
-- );

-- INSERT INTO tblemployee VALUES ('Bob','B','Bender','666666600','1968-04-17','8794 Garfield, Chicago, IL','M','96000.00',NULL,'8' ),
...
create table tbldeptlocations (
    ...
    foreign key (Dnumber) references tbldepartment(Dnumber)
